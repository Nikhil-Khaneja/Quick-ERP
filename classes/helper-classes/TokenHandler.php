...
class TokenHandler
{
    protected static $REMEMBER_EXPIRY_TIME = "10 MINS";
    const REMEMBER_ME_EXPIRY_TIME_IN_SECONDS = 600;

    protected static $FORGOT_PWD_EXPIRY_TIME = "15 MINS";
    ...
    public function createForgotPassword(int $user_id)
    {
